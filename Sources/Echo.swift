...
actor EchoFilter {
  private var window: [(Date, words: Set<String>, bigrams: Set<String>)] = []
  ...
  func isEcho(_ text: String) -> Bool {
    ...
    // Very short phrases are not judged: "yes", "right" or "exactly" match
    // anything, and there is no way to tell echo from a real reply.
